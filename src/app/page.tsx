...
export const metadata: Metadata = {
  title: 'MSP IT Support for Small Practices | Senyo Solutions',
  description:
    'Senyo Solutions provides simple, secure managed IT support for small practices on Long Island, New York, and New Jersey. Month-to-month plans with no long-term contracts.',
  alternates: {
