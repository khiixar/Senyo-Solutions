...
const projects = [
  { name: 'Janooon Cafe', img: '/images/janooon-cafe.png', tags: ['Restaurant', 'Web Design'], desc: 'A modern, elegant website for a South Asian cafe featuring authentic flavors and contemporary design. Built with responsive design and integrated menu system.', tech: ['HTML5', 'Tailwind CSS', 'JavaScript', 'Responsive Design'], url: 'https://janoooncafe.com' },
  { name: 'RelianceRX', img: '/images/reliance-rx.png', tags: ['Pharmaceutical', 'E-commerce'], desc: 'A comprehensive pharmaceutical solutions platform with product catalog, inventory management, and professional healthcare services integration.', tech: ['HTML5', 'Tailwind CSS', 'JavaScript', 'Database Integration'], url: 'https://reliancerx.us' },
